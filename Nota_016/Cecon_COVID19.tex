...
\label{sec:org711bd8c}

\subsection*{Google Reports: Brasil}
\label{sec:org972053b}
...
\label{sec:orgf8411f0}

\subsubsection*{Serviços}
\label{sec:org8f8fe55}
...
\section*{Crédito}
\label{sec:org50487ed}

\subsection*{Endividamento das famílias}
\label{sec:org168c87f}
...
\section*{PNAD-COVID}
\label{sec:orgd4e5825}
\subsection*{R trial}
\label{sec:orgea36732}
\subsection*{Home office - Por sexo e cor}
\label{sec:org733fa33}
...
\label{sec:org1946675}
\subsection*{Medidas fiscais em \% do PIB}
\label{sec:orgcfe07bd}
...
\label{sec:org47634c4}


\subsection*{GDP vs Lockdown}
\label{sec:org3e7dfab}
\begin{table}[htbp]
...
\label{sec:orgae2cd6a}
\subsection*{Inspeção dos picos}
\label{sec:org9825beb}
