...
#+BEGIN_SRC python :results graphics file :file ./figs/PIB/OfertaServicos_Acum.pdf
df = pd.read_excel(
    "./raw/ContasNacionais/Tab_Compl_CNT.xlsx",
    header=3,
    sheet_name="Acum. em 4 trimestres",
...
fig.savefig(
    "./figs/PIB/OfertaServicos_Acum" + ".pdf",
    dpi=300,
    bbox_inches="tight",
    pad_inches=0,
)
...
** TODOs :noexport:
*** TODO Refinar datação dos picos
*** TODO Remover outlier dos boxplots
*** TODO Repensar nome das ondas
*** TODO Reordenar factors
