...
(python3:291370): Gtk-[1;33mWARNING[0m **: [34m08:55:12.598[0m: Theme parsing error: gtk.css:1:117: Failed to import: Erro ao abrir arquivo /home/gpetrini/.local/share/gnome-shell/extensions/unite@hardpixel.eu/styles/buttons-right-always.css: Arquivo ou diretório inexistente
:end:
** R
...
for(estado in estados){
  ...
  if(estado == "RO"){
    legend_2 <- get_legend(
                                        # create some space to the left of the legend
      p2 +
      theme(legend.box.margin = margin(0, 0, 0, 12), legend.title=element_text(size=16), legend.text=element_text(size=14)) +
...
ggsave(name, width = 50, height = 70, units = "cm")
print(name)
#+end_src
