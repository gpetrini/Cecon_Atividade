...
(python3:31385): Gtk-[1;33mWARNING[0m **: [34m18:11:29.313[0m: Theme parsing error: gtk.css:1:117: Failed to import: Erro ao abrir arquivo /home/gpetrini/.local/share/gnome-shell/extensions/unite@hardpixel.eu/styles/buttons-right-always.css: Arquivo ou diretório inexistente
:end:
** R
...
#+RESULTS:
:results:
--2021-04-01 17:25:00--  https://data.brasil.io/dataset/covid19/caso_full.csv.gz
Resolvendo data.brasil.io (data.brasil.io)... 2606:4700:20::ac43:472d, 2606:4700:20::681a:9af, 2606:4700:20::681a:8af, ...
Conectando-se a data.brasil.io (data.brasil.io)|2606:4700:20::ac43:472d|:443... conectado.
A requisição HTTP foi enviada, aguardando resposta... 200 OK
Tamanho: 42789488 (41M) [application/gzip]
Salvando em: “./raw/Covid/Casos_Brasilio.csv.gz”
[                    ]       0  --.-KB/s                        ./raw/Covi   0%[                    ]  99,52K   355KB/s                       ./raw/Covid   1%[                    ] 439,39K   751KB/s                      ./raw/Covid/   2%[                    ]   1,12M  1,42MB/s                     ./raw/Covid/C   4%[                    ]   1,91M  1,93MB/s                    ./raw/Covid/Ca   6%[>                   ]   2,77M  2,32MB/s                   ./raw/Covid/Cas   8%[>                   ]   3,46M  2,47MB/s                  ./raw/Covid/Caso  10%[=>                  ]   4,32M  2,69MB/s                 ./raw/Covid/Casos  12%[=>                  ]   4,99M  2,75MB/s                ./raw/Covid/Casos_  13%[=>                  ]   5,57M  2,76MB/s               ./raw/Covid/Casos_B  15%[==>                 ]   6,38M  2,88MB/s               /raw/Covid/Casos_Br  17%[==>                 ]   7,21M  2,98MB/s               raw/Covid/Casos_Bra  19%[==>                 ]   7,99M  3,05MB/s               aw/Covid/Casos_Bras  21%[===>                ]   8,73M  3,08MB/s               w/Covid/Casos_Brasi  22%[===>                ]   9,26M  3,05MB/s    TED 10s    /Covid/Casos_Brasil  24%[===>                ]  10,04M  3,10MB/s    TED 10s    Covid/Casos_Brasili  26%[====>               ]  10,85M  3,41MB/s    TED 10s    ovid/Casos_Brasilio  28%[====>               ]  11,69M  3,58MB/s    TED 10s    vid/Casos_Brasilio.  30%[=====>              ]  12,43M  3,67MB/s    TED 10s    id/Casos_Brasilio.c  32%[=====>              ]  13,16M  3,67MB/s    TED 9s     d/Casos_Brasilio.cs  32%[=====>              ]  13,39M  3,49MB/s    TED 9s     /Casos_Brasilio.csv  35%[======>             ]  14,57M  3,60MB/s    TED 9s     Casos_Brasilio.csv.  37%[======>             ]  15,19M  3,56MB/s    TED 9s     asos_Brasilio.csv.g  38%[======>             ]  15,85M  3,51MB/s    TED 9s     sos_Brasilio.csv.gz  40%[=======>            ]  16,60M  3,54MB/s    TED 7s     os_Brasilio.csv.gz   42%[=======>            ]  17,44M  3,62MB/s    TED 7s     s_Brasilio.csv.gz    44%[=======>            ]  18,18M  3,61MB/s    TED 7s     _Brasilio.csv.gz     46%[========>           ]  18,99M  3,57MB/s    TED 7s     Brasilio.csv.gz      48%[========>           ]  19,85M  3,60MB/s    TED 7s     rasilio.csv.gz       50%[=========>          ]  20,65M  3,61MB/s    TED 6s     asilio.csv.gz        52%[=========>          ]  21,48M  3,70MB/s    TED 6s     silio.csv.gz         54%[=========>          ]  22,27M  3,70MB/s    TED 6s     ilio.csv.gz          56%[==========>         ]  23,13M  3,72MB/s    TED 6s     lio.csv.gz           58%[==========>         ]  23,94M  3,70MB/s    TED 6s     io.csv.gz            60%[===========>        ]  24,60M  3,72MB/s    TED 5s     o.csv.gz             62%[===========>        ]  25,40M  3,73MB/s    TED 5s     .csv.gz              63%[===========>        ]  26,10M  3,77MB/s    TED 5s     csv.gz               65%[============>       ]  26,83M  3,74MB/s    TED 5s     sv.gz                67%[============>       ]  27,65M  3,84MB/s    TED 5s     v.gz                 69%[============>       ]  28,46M  3,86MB/s    TED 4s     .gz                  71%[=============>      ]  29,30M  3,89MB/s    TED 4s     gz                   73%[=============>      ]  30,15M  3,91MB/s    TED 4s     z                    75%[==============>     ]  30,93M  3,91MB/s    TED 4s                          77%[==============>     ]  31,74M  3,91MB/s    TED 4s                       .  79%[==============>     ]  32,49M  3,86MB/s    TED 2s                      ./  81%[===============>    ]  33,29M  3,87MB/s    TED 2s                     ./r  83%[===============>    ]  34,04M  3,87MB/s    TED 2s                    ./ra  85%[================>   ]  34,94M  3,89MB/s    TED 2s                   ./raw  87%[================>   ]  35,80M  3,89MB/s    TED 2s                  ./raw/  89%[================>   ]  36,63M  3,93MB/s    TED 1s                 ./raw/C  91%[=================>  ]  37,49M  3,97MB/s    TED 1s                ./raw/Co  93%[=================>  ]  38,24M  3,95MB/s    TED 1s               ./raw/Cov  95%[==================> ]  38,83M  3,91MB/s    TED 1s              ./raw/Covi  97%[==================> ]  39,66M  3,90MB/s    TED 1s             ./raw/Covid  98%[==================> ]  40,40M  3,90MB/s    TED 0s     ./raw/Covid/Casos_B 100%[===================>]  40,81M  3,91MB/s    em 11s

2021-04-01 17:25:12 (3,61 MB/s) - “./raw/Covid/Casos_Brasilio.csv.gz” salvo [42789488/42789488]
:end:
...
df <- df %>%
  ...
  mutate(Isolamento_14 = case_when(
     stayhome_growth_14 >= 0 & Stay_at_home == TRUE ~ "Rígido", # Queda da mobilidade junto da imposição
     stayhome_growth_14 > 0 & Policy_change > 0  & Stay_at_home == FALSE ~ "Brando",
     stayhome_growth_14 > 0 & Policy_change <=0 & Stay_at_home == FALSE ~ "Voluntário", # Queda da mobilidade sem restrição
     stayhome_growth_14 < 0 ~ "Queda",
           )) %>%
  mutate(Isolamento_Federal = case_when(
     stayhome_growth_14 >= 0 & Stay_at_home_federal == TRUE ~ "Rígido", # Queda da mobilidade junto da imposição
     stayhome_growth_14 > 0 & Policy_change > 0  & Stay_at_home_federal == FALSE ~ "Brando",
     stayhome_growth_14 > 0 & Policy_change <=0 & Stay_at_home_federal == FALSE ~ "Voluntário", # Queda da mobilidade sem restrição
     stayhome_growth_14 < 0 ~ "Queda",
           )) %>%
...
df <- read_csv(
  ...
  mutate(Isolamento_14 = factor(Isolamento_14, levels = c("Rígido", "Brando", "Voluntário", "Queda", NA))) %>%
  select(
    date,
    iso_code,
    new_cases_per_million,
...
df <- df %>%
  ...
  mutate(Onda = case_when(
    total_deaths >= th_total_deaths & nPico == 0 ~ "Início ao 1o pico",
    total_deaths >= th_total_deaths & nPico == 1 ~ "1o ao 2o Pico",
    total_deaths >= th_total_deaths & nPico >= 2 ~ "pós 2o pico"
  )) %>%
...
** Novos casos por milhão x Fase pandemia (mais de 10 casos por milhão de habitante)
...
:results:
[[file:./figs/COVID/Casos_Policy_10_Todos.pdf]]
** Novos casos por milhão x Fase pandemia (mais de 50 casos por milhão de habitante)
...
** Novos casos por milhão x Fase pandemia (mais de 100 casos por milhão de habitante)
...
Para isso, associa-se o tipo de isolamento social (se voluntário, imposto ou em queda) com as diferentes fases da pandemia e com as taxas de crescimento de novos casos por meio de /boxplots/ como indicado pela figura abaixo.
...
Em seguida, para determinar o tipo de isolamenta social, comparou-se o tempo que as pessoas ficaram em casa em relação a src_R[:export results :results value]{print(w/2)} {{{results(14)}}} dias atrás a partir dos dados de mobilidade do Google (Citar).
...
Com estes dados a mão, relacionou-se tais informações por meio de /boxplots/.
...
* Mobilidade e políticas implementadas
...
df <- read_csv(
  ...
  mutate(C6 = case_when(
           ...
           C6 == 2 ~ "Algumas exceções\npodem sair",
           C6 == 3 ~ "Sem exceções\npara sair"),
    C6 = fct_relevel(C6, "Sem medida", "Recomendado ficar\nem casa", "Algumas exceções\npodem sair", "Sem exceções\npara sair"))
...
p2 <- tmp_long %>%  ggplot(aes(x = date, y = Measure, color=name) ) +
  ...
  scale_size_discrete(name = "Abrangência", labels = c("Focalizado", "Federal"), limits = c("0","1")) +
  theme_minimal() +
  theme(
...
** Dados de políticas adotdas :noexport:
...
df <-read_csv(
  ...
  mutate(
    C6 = case_when(
           ...
           C6 == 2 ~ "Algumas exceções\npodem sair",
           C6 == 3 ~ "Sem exceções\npara sair",
           is.na(C6) ~ "Dados indisponíveis"
      )) %>%
  mutate(C6 = factor(C6)) %>%
  mutate(C6 = fct_relevel(C6, "Dados indisponíveis", "Sem medida", "Recomendado ficar\nem casa", "Algumas exceções\npodem sair", "Sem exceções\npara sair")) %>%
...
df <- df %>%
  ...
  mutate(Isolamento = case_when(
     stayhome_growth_after >= 0 & C6 == "Algumas exceções\npara sair" |  C6 == "Sem exceções\npara sair" ~ "Rígido", # Queda da mobilidade junto da imposição
     stayhome_growth_after > 0 & Policy_change > 0  &  C6 == "Recomendado ficar\nem casa" | C6 == "Sem medida" ~ "Brando",
     stayhome_growth_after > 0 & Policy_change <=0 & C6 != "Sem exceções\npara sair" ~ "Voluntário", # Queda da mobilidade sem restrição
     stayhome_growth_after < 0 ~ "Queda",
     is.na(stayhome_growth_after) | is.na(Policy_change) ~ "Dados indisponíveis"
           )) %>%
...
df <- df %>%
  ...
  ungroup() %>%
  mutate(y.max = zoo::rollapply(new_cases, 2 * w + 1, max, fill = NA, align = "center")) %>%
  mutate(delta = y.max - new_cases) %>%
  mutate(Pico = new_cases >= th_new_cases & delta <= 0) %>%
  group_by(Sigla) %>%
  fill(Pico, .direction = "up") %>%
  mutate(nPico = cumsum(Pico)) %>%
  ungroup() %>%
...
** Gráficos de mobilidade e política por estados
...
df <- read_csv(
  ...
  mutate(C6 = factor(C6),
         C6 = fct_relevel(C6, "Dados indisponíveis", "Sem medida", "Recomendado ficar\nem casa", "Algumas exceções\npodem sair", "Sem exceções\npara sair"))
...
for(estado in estados){
  ...
  rescale <- ((replace_na(tmp$new_cases_100K,0) %>% max())/(replace_na(tmp$Residential, 0) %>% max()))  %>% round()
                                        # color = new_cases não tem legenda adequada  
  ...
  p2 <- tmp_long %>%
    ...
    scale_color_manual(
      ...
      breaks=c("Dados indisponíveis", "Sem medida", "Recomendado ficar\nem casa", "Algumas exceções\npodem sair", "Sem exceções\npara sair"),
      name=policy_name) +
    theme_minimal() +
    theme(
      legend.position = "right",
  ...
  fig <- cowplot::plot_grid(
                    ...
                    p2 + theme(plot.margin = margin(t=-.9, b=1., unit="cm"), axis.text.x = element_blank()),
                    nrow = 2,
                    rel_heights = c(3,0.5),
                    align="v",
                    axis="lr"
...
fig <- ggdraw(fig) +
  draw_image(logo_file, x = 0.999, y = .975, hjust = 1, vjust = 1, width = 0.125, height = 0.1)
ggsave(name, width = 60, height = 40, units = "cm")
print(name)
#+end_src

#+RESULTS:
:results:
[[file:./figs/COVID/Estados/Mobilidade_Policy_selected_C6.pdf]]
:end:
...
df %>%
  ...
  scale_fill_manual(
      ...
      breaks=c("Dados indisponíveis", "Queda", "Brando", "Rígido", "Voluntário"),
