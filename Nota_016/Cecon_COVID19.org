...
Nela, associa-se o tipo de isolamento social (se voluntário, imposto ou em queda) com as diferentes fases da pandemia e com as taxas de crescimento de novos casos por meio de /boxplots/.
...
Os dados de política de restrição são extraídos da base BASE e foram utilizadas as medidas do grupo "C" que dizem respeito à medidas de mobilidade que englobal: C1 ... C8.
