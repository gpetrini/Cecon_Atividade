...
(python3:145670): Gtk-[1;33mWARNING[0m **: [34m13:46:22.130[0m: Theme parsing error: gtk.css:1:117: Failed to import: Erro ao abrir arquivo /home/gpetrini/.local/share/gnome-shell/extensions/unite@hardpixel.eu/styles/buttons-right-always.css: Arquivo ou diretório inexistente
:end:
** R
...
[1] "./figs/COVID/Picos.pdf"
[1] "./figs/COVID/Casos_Policy_Todos.pdf"
[1] "./figs/COVID/Casos_Policy_10_Todos.pdf"
[1] "./figs/COVID/Casos_Policy_50_Todos.pdf"
...
cols(
  ...
  Stay_at_home = [33mcol_logical()[39m,
  Stay_at_home_federal = [33mcol_logical()[39m,
  Policy = [31mcol_character()[39m,
  Pico = [33mcol_logical()[39m,
  Onda = [31mcol_character()[39m,
  Strigency_type = [31mcol_character()[39m
)
[36mℹ[39m Use [30m[47m[30m[47m`spec()`[47m[30m[49m[39m for the full column specifications.

`summarise()` has grouped output by 'iso_code'. You can override using the `.groups` argument.
[1] "./figs/COVID/Mobilidade_Policy_USA_C6.pdf"
`summarise()` has grouped output by 'iso_code'. You can override using the `.groups` argument.
[1] "./figs/COVID/Mobilidade_Policy_SWE_C6.pdf"
`summarise()` has grouped output by 'iso_code'. You can override using the `.groups` argument.
[1] "./figs/COVID/Mobilidade_Policy_ARG_C6.pdf"
`summarise()` has grouped output by 'iso_code'. You can override using the `.groups` argument.
[1] "./figs/COVID/Mobilidade_Policy_BRA_C6.pdf"
`summarise()` has grouped output by 'iso_code'. You can override using the `.groups` argument.
[1] "./figs/COVID/Mobilidade_Policy_PRY_C6.pdf"
`summarise()` has grouped output by 'iso_code'. You can override using the `.groups` argument.
[1] "./figs/COVID/Mobilidade_Policy_URY_C6.pdf"
`summarise()` has grouped output by 'iso_code'. You can override using the `.groups` argument.
[1] "./figs/COVID/Mobilidade_Policy_VEN_C6.pdf"
`summarise()` has grouped output by 'iso_code'. You can override using the `.groups` argument.
[1] "./figs/COVID/Mobilidade_Policy_PRT_C6.pdf"
`summarise()` has grouped output by 'iso_code'. You can override using the `.groups` argument.
[1] "./figs/COVID/Mobilidade_Policy_GBR_C6.pdf"
[1] "./figs/COVID/Mobilidade_Policy_selected_C6.pdf"
...
for(estado in estados){
  ...
  fig <- cowplot::plot_grid(
                    ...
                    p2 + theme(plot.margin = margin(t=-1.2, b=1., unit="cm"), axis.text.x = element_blank()) + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(), panel.background = element_blank()),
                    nrow = 2,
                    rel_heights = c(3,0.5),
                    align="v",
                    axis="lr"
...
ggsave(name, width = 64, height = 40, units = "cm")
print(name)
#+end_src
