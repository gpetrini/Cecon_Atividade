...
fig.savefig(
    image_path + file_path.strip("/")[-1] + "PO_Atividade" + "_" + '.png',
    dpi = 300, 
    bbox_inches='tight',pad_inches=0
    )
#+END_SRC
...
fig.savefig(
    image_path + file_path.strip("/")[-1] + var.replace(" ", "_") + "_" + "linha" +  '.png',
    dpi = 300, 
    bbox_inches='tight',pad_inches=0
    )
#+END_SRC
...
fig.savefig(
    image_path + file_path.strip("/")[-1] + "PO_Atividade" + "_" + "linha" + '.png',
    dpi = 300, 
    bbox_inches='tight',pad_inches=0
    )
#+END_SRC
